...
function DoctorDashboard() {
  ...
  const [currentPage, setCurrentPage] = useState('appointments'); // Changed default to appointments
  ...
  // Simplified navigation for doctors - appointments and salary
  const navigationItems = [
    { id: 'appointments', label: 'My Appointments', icon: 'appointments' },
  ...
  return (
    <div className="dashboard-layout">
      ...
      <div className="main-content">
        ...
        {currentPage === 'appointments' && <DoctorAppointments />}
        {currentPage === 'accounts' && <Accounts restrictToMySalary={true} />}
      </div>
    </div>
  );
}
